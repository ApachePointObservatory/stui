array set interlockDescriptions [list \
   ...
   version_id {Version 29  $Name: NOTAG $} \
   ...
   im_ff_uv_on_req {} \
   spare_b3_13_15 {} \
   cartridge_10 {Cartridge 10 on telescope} \
   cartridge_11 {Cartridge 11 on telescope} \
   cartridge_12 {Cartridge 12 on telescope} \
   cartridge_13 {Cartridge 13 on telescope} \
   cartridge_14 {Cartridge 14 on telescope} \
   cartridge_15 {Cartridge 15 on telescope} \
   cartridge_16 {Cartridge 16 on telescope} \
   cartridge_17 {Cartridge 17 on telescope} \
   cartridge_18 {Cartridge 18 on telescope} \
   spare_b3_14_9 {} \
   spare_b3_14_10 {} \
   spare_b3_14_11 {} \
   spare_b3_14_12 {} \
   ...
   spare_b3_15_8 {} \
   spare_b3_15_9 {} \
   apogee_gc_at_1m {APOGEE gang connector at 1m port} \
   apogee_gc_at_sparse {APOGEE gang connector at sparse calibration port} \
   apogee_gc_at_dense {APOGEE gang connector plugged into dense calibration port} \
   apogee_gc_at_stow {APOGEE gang connector at stow position (any port in podium)} \
   apogee_gc_at_cart {APOGEE gang connector plugged into a cartridge} \
   apogee_gc_unplugged {APOGEE gang connector unplugged} \
   spare_b3_16_0 {} \
   spare_b3_16_1 {} \
   spare_b3_16_2 {} \
   spare_b3_16_3 {} \
   ...
   ffs_dimm_alt_lim {Lower Altitude Limit for FFS Enable In DIMM Avoidance Zone} \
   ...
   apogee_fgc_1m_sw {Status switch for APOGEE gang connector in 1m port.} \
   apogee_fgc_sparse_sw {Status switch for APOGEE gang connector in sparse port} \
   apogee_fgc_dense_sw {Status switch for APOGEE gang connector in dense port} \
   apogee_gc_at_cart_sw {Status switch for APOGEE gang connector plugged into cartridge} \
   apogee_gc_at_stow_sw {Status switch for APOGEE gang connector in stow position  any port} \
   ...
   sad_latch1_cls {Saddle latches open} \
   ...
   az_near_dimm {Switch defines azimuth range near DIMM} \
   ...
   viktory_guardpin {Extend pin to protect gang connector in cartridge from Lindy cart} \
