...
proc set_B3_L7 {val} {
   ...
   set mcpData(cartridge_18) [expr ($val & (1 << 24)) != 0]
   set mcpData(cartridge_17) [expr ($val & (1 << 23)) != 0]
   set mcpData(cartridge_16) [expr ($val & (1 << 22)) != 0]
   set mcpData(cartridge_15) [expr ($val & (1 << 21)) != 0]
   set mcpData(cartridge_14) [expr ($val & (1 << 20)) != 0]
   set mcpData(cartridge_13) [expr ($val & (1 << 19)) != 0]
   set mcpData(cartridge_12) [expr ($val & (1 << 18)) != 0]
   set mcpData(cartridge_11) [expr ($val & (1 << 17)) != 0]
   set mcpData(cartridge_10) [expr ($val & (1 << 16)) != 0]
   set mcpData(apogee_gc_unplugged) [expr ($val & (1 << 15)) != 0]
   set mcpData(apogee_gc_at_cart) [expr ($val & (1 << 14)) != 0]
   set mcpData(apogee_gc_at_stow) [expr ($val & (1 << 13)) != 0]
   set mcpData(apogee_gc_at_dense) [expr ($val & (1 << 12)) != 0]
   set mcpData(apogee_gc_at_sparse) [expr ($val & (1 << 11)) != 0]
   set mcpData(apogee_gc_at_1m) [expr ($val & (1 << 10)) != 0]
...
proc set_I1_L0 {val} {
   ...
   set mcpData(apogee_gc_at_stow_sw) [expr ($val & (1 << 14)) != 0]
   set mcpData(apogee_gc_at_cart_sw) [expr ($val & (1 << 13)) != 0]
   set mcpData(apogee_fgc_dense_sw) [expr ($val & (1 << 12)) != 0]
   set mcpData(apogee_fgc_sparse_sw) [expr ($val & (1 << 11)) != 0]
   set mcpData(apogee_fgc_1m_sw) [expr ($val & (1 << 10)) != 0]
...
proc set_I8_L0 {val} {
   ...
   set mcpData(az_near_dimm) [expr ($val & (1 << 14)) != 0]
...
proc set_O1_L1 {val} {
   ...
   set mcpData(viktory_guardpin) [expr ($val & (1 << 26)) != 0]
