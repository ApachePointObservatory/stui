...
MainDataList = (
    ...
    "snrH12Target=30",
    "utrData=6, 1, 10, 1.0, 1.0, 1.0, 1.0, 0, 0.51, 0.50, 1.0, 633.0, 3",
    "utrData=6, 2, 15, 1.0, 1.0, 1.0, 1.0, 0, 0.51, 0.50, 1.0, 633.0, 3",
    "utrData=6, 3, 20, 1.0, 1.0, 1.0, 1.0, 0, 0.51, 0.50, 1.0, 633.0, 3",
    "utrData=6, 4, 24, 1.0, 1.0, 1.0, 1.0, 0, 0.51, 0.50, 1.0, 633.0, 3",
    "utrData=6, 5, 28, 1.0, 1.0, 1.0, 1.0, 0, 0.51, 0.50, 1.0, 633.0, 3",
    "snrAxisRange=14, 32",
)
