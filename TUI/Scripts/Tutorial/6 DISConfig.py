...
def run(sr):
	...
	in the right location, so this script checks each item before moving.
	"""
	...
	# note that disModel.cmdLambdas is used, not disModel.actLambdas
	# the gratings cannot necessarily go *exactly* where requested
